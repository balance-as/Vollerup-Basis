table 97701 "BAL Job Buffer"
{
    ...
    keys
    {
        key(Key1; "Account No. 1", "Account No. 2","BAL Quality")
        {
            Clustered = true;
        }
    }
    ...
    var
        TempJobBuffer: array[2] of Record "BAL Job Buffer" temporary;
    ...
    procedure GetJobBuffer(var Job: Record Job; var JobBuffer2: Record "BAL Job Buffer")
    var
    ...
    procedure ReportJobItem(var Job: Record Job; var item2: Record Item; var JobBuffer2: Record "BAL Job Buffer")
    var
        Item: Record Item;
        Item3: Record Item;
            ...
            repeat
                ...
                then begin
                    ...
                    if InFilter then begin
                        ...
                        TempJobBuffer[1]."BAL Width" := JobLedgEntry."BAL Width";
                        TempJobBuffer[1]."BAL Length" := JobLedgEntry."BAL Length";
                        TempJobBuffer[1]."BAL Quality" := JobLedgEntry."BAL Quality";
                        TempJobBuffer[1]."BAL Total Length" := JobLedgEntry."BAL Total Length";
                        TempJobBuffer[2] := TempJobBuffer[1];
    ...
    procedure ReportItemJob(var Item: Record Item; var Job2: Record Job; var JobBuffer2: Record "BAL Job Buffer")
    var
        JobLedgEntry: Record "Job Ledger Entry";
        Job: Record Job;
        Job3: Record Job;
